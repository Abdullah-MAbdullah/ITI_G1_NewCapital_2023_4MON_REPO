...
{
	/*Set The FastPWM Mode*/
	SET_BIT(TCCR0, TCCR0_WGM00);
	SET_BIT(TCCR0, TCCR0_WGM01);
	/*Select The Set On Top, Clear On Compare (Non-Inverted Mode)*/
...
void TIMER0_voidSetBusyWait_OCMode(u32 Copy_u32Time)
{
	...
	TCNT0 = 0x00;
	/*Set The Compare Match Value to 250*/
	...
	/*Re-set the prescaler value to the user's choice*/
}
